  ...
  ngOnInit(): void {
    this.productService.getSotck().subscribe(data =>{
      data.forEach(product => {
        let dataproduct ={ID:product.id,Sku:product.sku,Description:product.description,Brand:product.brand,Category:product.categoryName,Stock:product.stock,UpdateDate:product.outgress}
